                ...
                <form action="{{ route('kamar.update', $kamar->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jenis_kamar" name="jenis_kamar"
                            value="{{ old('jenis_kamar', $kamar->jenis_kamar) }}" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="kapasitas_tamu" name="kapasitas_tamu"
                            value="{{ old('kapasitas_tamu', $kamar->kapasitas_tamu) }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="fasilitas_kamar" class="form-label">Fasilitas Kamar</label>
                        <textarea class="form-control" id="fasilitas_kamar" name="fasilitas_kamar" required>{{ old('fasilitas_kamar', $kamar->fasilitas_kamar) }}</textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="harga_per_malam" name="harga_per_malam"
                            value="{{ old('harga_per_malam', $kamar->harga_per_malam) }}" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="jumlah_kamar_tersedia" name="jumlah_kamar_tersedia"
                            value="{{ old('jumlah_kamar_tersedia', $kamar->jumlah_kamar_tersedia) }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="foto_kamar" class="form-label">Foto Kamar</label>
                        @if ($kamar->foto_kamar)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $kamar->foto_kamar) }}" alt="foto kamar" width="80">
                            </div>
                        @endif
